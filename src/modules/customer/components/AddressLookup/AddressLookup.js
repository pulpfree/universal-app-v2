...
const AddressLookup = ({ navigation }) => {
  const navFrom = navigation.getParam('from')
      ...
      <View style={[styles.modalBox]}>
        ...
        <GooglePlacesAutocomplete
          ...
          onPress={(data, details = null) => { // 'details' is provided when fetchDetails = true
            ...
            navigation.navigate(navFrom, { mapParams: details })
          }}
          ...
          debounce={200} // debounce the requests in ms. Set to 0 to remove debounce. Default is 0ms
        />
      </View>
    </View>
  )
